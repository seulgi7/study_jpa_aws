...
public class OAuthAttributes {
    ...
    public static  OAuthAttributes of(String registrationId, String userNameAttributeName, Map<String,Object> attributes){
        ...
        return ofGoolge(registrationId, userNameAttributeName, attributes);
    }
    ...
    public static  OAuthAttributes ofGoolge(String registrationId, String userNameAttributeName, Map<String,Object> attributes){
        return OAuthAttributes.builder()
